...
if ($method === 'POST') {
    try {
        ...
        if ($rutaArchivoFinal === null) {
            ...
            $stmt = $conn->prepare("INSERT INTO casas_habitantes (nombre, numero, lugar, detalles, creado, documento) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        http_response_code(500);
        echo json_encode(["error" => "Error al crear agencia: " . $e->getMessage()]);
    }
    exit;
}
